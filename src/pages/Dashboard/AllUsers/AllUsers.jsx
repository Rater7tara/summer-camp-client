...
const AllUsers = () => {
    ...
    const handleMakeInstructor = user =>{
        fetch(`https://summer-camp-server-git-main-rater7tara.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data => {
    ...
    const handleMakeAdmin = user =>{
        fetch(`https://summer-camp-server-git-main-rater7tara.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
        .then(res => res.json())
        .then(data => {
    ...
    const handleDelete = user => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://summer-camp-server-git-main-rater7tara.vercel.app/users/${user._id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
